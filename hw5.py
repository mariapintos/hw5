...
def car_at_light(light):
    if light == "red":
        ...
        return "Undefined instruction for color: {light} where {light} \
             is the value of the parameter light."
...
print(safe_substract(2, 3))
print(safe_substract(2, "a"))
